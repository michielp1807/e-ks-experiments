...
>
  ...
  <div class="form-row">
    <fieldset
      class="checklist"
      data-potty="Op dit moment ondersteunen we alleen partijen met een op zichzelf staande geregistreerde naam."
    >
      ...
      <div class="checkbox">
        ...
        <label for="registered_name">
          ...
          <span class="hint"
            >De partij neemt als één eenduidige partij deel aan de verkiezing.</span
          >
        </label>
      </div>
      <div class="checkbox">
        ...
        <label for="name_combination">
          ...
          <span class="hint"
            >De partij heeft een samenwerkingsverband met één of meer andere
            geregistreerde partijen. Samen leveren zij alle kandidaten voor de
            kandidatenlijst.</span
          >
        </label>
      </div>
      <div class="checkbox">
  ...
  <div class="form-row">
    <fieldset
      class="checklist"
      data-potty="Alleen partijen die bij de vorige verkiezing minstens 16 zetels hebben behaald mogen meer dan 50 candidaten op hun lijst zetten."
    >
      <legend class="legend-md"
        >Uw partij heeft bij de vorige Eerste Kamerverkiezing 16 zetels of meer
        behaald:</legend
      >
      <span class="hint"
        >Dit bepaalt of u 50 of 80 kandidaten per lijst op mag voeren.</span
      >
      <div class="checklist">
        <div class="checkbox">
          <input
            bind:group={draft.longListAllowed}
            type="radio"
            id="long_list_yes"
            name="long_list_allowed"
            value={true}
          />
  ...
  <div class="form-row">
    <p class="form-field" data-potty="">
      <label for="display_name">Geregistreerde aanduiding</label>
      <input bind:value={draft.displayName} id="display_name" type="text" />
      <span class="hint"
        >De naam die is geregistreerd bij het centraal stembureau. Deze komt op
        het stembiljet te staan.</span
      >
    </p>
  </div>
  <div class="form-row">
    <p class="form-field">
      ...
      <span class="hint"
        >De naam die is vastgelegd in de notariële akte en bij de Kamer van
        Koophandel.</span
      >
    </p>
  </div>
