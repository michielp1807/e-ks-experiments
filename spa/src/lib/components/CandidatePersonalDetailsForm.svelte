<script lang="ts">
	...
	function nextHref() {
		return personLivesInNl(draft)
			? resolve('/candidate-lists/[id]/candidates/[personId]/address', { id: candidateList.id, personId: draft.id })
			: resolve('/candidate-lists/[id]/candidates/[personId]/representative', { id: candidateList.id, personId: draft.id });
	}
</script>
		...
		<fieldset>
			...
			<div class="form-row">
				<p class="form-field">
					...
					<input bind:value={draft.personalData.placeOfResidence} id="place_of_residence" type="text" />
				</p>
				<p class="form-field form-field-sm">
					<label for="country">Landcode</label>
					<CountryCodeInput bind:value={draft.personalData.country} id="country" />
				</p>
			</div>
			<div class="form-row">
				<p class="form-field">
				...
				<p class="form-field form-field-md">
					...
					<input bind:value={draft.personalData.dateOfBirth} id="date_of_birth" type="text" placeholder="dd-mm-jjjj" />
				</p>
			</div>
			<div class="form-row">
				<p class="form-field">
