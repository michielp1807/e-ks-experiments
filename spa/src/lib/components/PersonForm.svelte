...
>
	<fieldset>
		...
		<div class="form-row">
			<p class="form-field">
				...
				<input bind:value={person.personalData.placeOfResidence} id="place_of_residence" type="text" />
			</p>
			<p class="form-field form-field-sm">
				<label for="country">Landcode</label>
				<CountryCodeInput bind:value={person.personalData.country} id="country" />
			</p>
		</div>
		<div class="form-row">
			<p class="form-field">
			...
			<p class="form-field form-field-md">
				...
				<input bind:value={person.personalData.dateOfBirth} id="date_of_birth" type="text" placeholder="dd-mm-jjjj" />
			</p>
		</div>
		<div class="form-row">
			<p class="form-field">
	...
	{:else}
		<fieldset>
			...
			<AddressFields address={person.representative.address} international={true} />
		</fieldset>
	{/if}

	<div class="buttons">
		<button class="button" type="submit">{submitLabel}</button>
		<span class={`status-pill ${isPersonComplete(person) ? 'complete' : 'warning'}`}>
