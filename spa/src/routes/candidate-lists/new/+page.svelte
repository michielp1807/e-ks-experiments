...
<section class="candidate-list-create">
  <div class="card plain-card">
    ...
    <p>
      Kies eerst de kandidatenlijst. Daarna kun je kieskringen, lijstinleveraars
      en kandidaten invullen.
    </p>
    <div class="buttons">
      <button
        ...
        onclick={() => {
          ...
          goto(
            resolve("/candidate-lists/[id]/details", { id: candidateList.id }),
          );
        }}
      >
        Kandidatenlijst aanmaken
      </button>
      <a class="button secondary" href={resolve("/candidate-lists")}
        >Annuleren</a
      >
    </div>
  </div>
