<script lang="ts">
	...
	import CandidateListCandidateEditForm from '$lib/components/CandidateListCandidateEditForm.svelte';
...
{#if candidateList && person}
	<CandidateEditOverlay {candidateList} {person} title={formatName(person.name)}>
		<CandidateListCandidateEditForm {appData} {candidateList} {person} />
