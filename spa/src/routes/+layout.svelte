    ...
    <ul>
      <li>
        <a
          ...
          class="home"
          aria-label="Home"><span>Home</span></a
        >
      </li>
      <li>
        <a
          href={resolve("/political-group")}
          class:active={routeId.startsWith("/political-group")}
        >
          Basisgegevens
        </a>
      </li>
      <li>
        <a
          href={resolve("/candidate-lists")}
          class:active={routeId.startsWith("/candidate-lists")}
        >
          Kandidatenlijsten
        </a>
      </li>
      <li>
        <a
          href={resolve("/submit")}
          class:active={routeId.startsWith("/submit")}>Afronden</a
        >
      </li>
    </ul>
    <ul>
  ...
  {#if header.current.title}
    <div class="header-content page-header">
      <div>
        ...
        {#if header.current.districts.length > 0}
          <div class="page-header-districts">
            <DistrictsList districts={header.current.districts} {locale} />
          </div>
      ...
      {#if header.current.backHref}
        <a href={resolve(header.current.backHref)} class="button secondary"
          >{header.current.backLabel}</a
        >
      {/if}
    </div>
  {/if}
...
<footer>
  <span>Kandidaatstelling - SPA Experiment</span>
  <span>Version <b>1.4.26</b></span>
</footer>
